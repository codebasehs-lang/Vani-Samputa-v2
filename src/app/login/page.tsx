    ...
    <div className="flex min-h-[80vh] items-center justify-center px-4 py-12">
      ...
      >
        ...
        <button
          ...
          className="mb-4 flex w-full items-center justify-center gap-2 rounded-xl border border-[var(--border)] py-2.5 text-sm font-medium text-[var(--foreground)] transition-colors hover:bg-black/5"
        >
        ...
        <p className="mt-4 text-center text-xs text-[var(--muted)]">
          ...
          <Link href="/register" className="font-medium" style={{ color: "var(--saffron)" }}>
            Register
          </Link>
        </p>
      </div>
